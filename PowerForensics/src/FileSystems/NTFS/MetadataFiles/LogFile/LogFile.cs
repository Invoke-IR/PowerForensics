...
namespace PowerForensics.Ntfs
{
    ...
    public class RestartAreaHeader
    {
        ...
        internal static RestartAreaHeader[] Get(byte[] bytes)
        {
            ...
            headerArray[0] = new RestartAreaHeader(Util.GetSubArray(bytes, 0x00, 0x1000));
            headerArray[1] = new RestartAreaHeader(Util.GetSubArray(bytes, 0x1000, 0x1000));
            return headerArray;
        }
    ...
    public class Restart
    {
        ...
        public static Restart[] Get(byte[] bytes)
        {
            ...
            restartArray[0] = new Restart(Util.GetSubArray(bytes, 0x00, 0x1000));
            restartArray[1] = new Restart(Util.GetSubArray(bytes, 0x1000, 0x1000));
