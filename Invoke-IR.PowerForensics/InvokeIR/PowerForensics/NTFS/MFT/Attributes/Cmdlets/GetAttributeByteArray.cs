...
namespace InvokeIR.PowerForensics.NTFS.MFT.Attributes
{
    ...
    #region GetAttributeByteArrayCommand
    /// <summary> 
    /// This class implements the Get-AttributeByteArray cmdlet. 
    /// </summary> 

    [Cmdlet(VerbsCommon.Get, "AttributeByteArray")]
    public class GetAttributeByteArrayCommand : PSCmdlet
    {
    ...
    #endregion GetAttributeByteArrayCommand
